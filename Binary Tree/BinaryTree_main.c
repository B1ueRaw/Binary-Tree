...
//    }
    ...
    switch (choice) {
      case 0:
        printf("\nTree Inserted!\n\n");
        created_employee = create_employee("43");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("15");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("87");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("33");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("39");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("63");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("81");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("54");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("60");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("67");
        insert_employee(&employee_tree, created_employee);
        created_employee = create_employee("99");
        insert_employee(&employee_tree, created_employee);
